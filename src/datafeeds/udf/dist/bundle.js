      ...
      try {
        ...
        for (; t < e; ++t) {
          ...
          (this._symbolsInfo[d] = _),
            ...
            (void 0 === h && void 0 === l) ||
              ((this._symbolsInfo[n(d, h, l)] = _), (this._symbolsInfo[n(e, h, l)] = _), (this._symbolsInfo[n(c, h, l)] = _)),
        ...
        this._send('timescale_marks', n)
          .then((e) => {
            if (!Array.isArray(e)) {
              const s = [];
              for (let t = 0; t < e.id.length; ++t)
                s.push({ id: c(e, 'id', t), time: c(e, 'time', t), color: c(e, 'color', t), label: c(e, 'label', t), tooltip: c(e, 'tooltip', t) });
              e = s;
            }
            o(e);
          })
