  ...
  return (
    <NavigationMenu.Root className='NavigationMenuRoot'>
      <NavigationMenu.List className='NavigationMenuList'>
        <NavigationMenu.Item>
          <NavigationMenu.Link className='NavigationMenuLink' onClick={() => history.push('/')}>
            Home
          </NavigationMenu.Link>
        </NavigationMenu.Item>
...
const ListItem = React.forwardRef(({ className, children, title, ...props }, forwardedRef) => {
  if (props.route) {
    return (
      <li onMouseEnter={recordMouseEnter}>
        <NavigationMenu.Link asChild>
          <NavLink to={props.route} className={classNames('ListItemLink', className)}>
    ...
    return (
      <li onMouseEnter={recordMouseEnter}>
        <NavigationMenu.Link asChild>
          <a className={classNames('ListItemLink', className)} {...props} ref={forwardedRef} target='_blank' rel='noopener noreferrer'>
            <div className='ListItemHeading'>{title}</div>
            <p className='ListItemText'>{children}</p>
          </a>
        </NavigationMenu.Link>
